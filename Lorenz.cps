...
<!-- generated with COPASI 4.30 (Build 240) (http://www.copasi.org) at 2021-05-31T14:06:35Z -->
...
<rdf:RDF
  ...
  <rdf:Description rdf:about="#Model_1">
    ...
    <Comment>
      A three-dimensional ODE system which has the butterfly chaotic attractor. 

Reference: Edward N Lorenz. Deterministic nonperiodic flow. Journal of the atmospheric sciences, 20(2):130-141, 1963.
    </Comment>
    <ListOfCompartments>
  ...
  <rdf:Description rdf:about="#Metabolite_0">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          &lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[x],Reference=Concentration>*&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[y],Reference=Concentration>-&lt;CN=Root,Model=New Model,Vector=Values[b],Reference=InitialValue>*&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[z],Reference=Concentration>
        </Expression>
      </Metabolite>
  ...
  <rdf:Description rdf:about="#Metabolite_1">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          -&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[x],Reference=Concentration>*&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[z],Reference=Concentration>+&lt;CN=Root,Model=New Model,Vector=Values[r],Reference=InitialValue>*&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[x],Reference=Concentration>-&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[y],Reference=Concentration>
        </Expression>
      </Metabolite>
  ...
  <rdf:Description rdf:about="#Metabolite_2">
    <dcterms:created>
      <rdf:Description>
        ...
        <Expression>
          &lt;CN=Root,Model=New Model,Vector=Values[sigma],Reference=InitialValue>*(-&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[x],Reference=Concentration>+&lt;CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[y],Reference=Concentration>)
        </Expression>
      </Metabolite>
    </ListOfMetabolites>
    <ListOfModelValues>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2021-05-31T14:05:49Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
        ...
        <ModelParameterGroup cn="String=Initial Species Values" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[z]" value="6.0221408570000002e+20" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[y]" value="6.0221408570000002e+20" type="Species" simulationType="ode"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[x]" value="6.0221408570000002e+20" type="Species" simulationType="ode"/>
        </ModelParameterGroup>
        <ModelParameterGroup cn="String=Initial Global Quantities" type="Group">
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[sigma]" value="10" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[b]" value="2.6499999999999999" type="ModelValue" simulationType="fixed"/>
          <ModelParameter cn="CN=Root,Model=New Model,Vector=Values[r]" value="90" type="ModelValue" simulationType="fixed"/>
        </ModelParameterGroup>
    ...
    <InitialState type="initialState">
      0 6.0221408570000002e+20 6.0221408570000002e+20 6.0221408570000002e+20 1 10 2.6499999999999999 90 
    </InitialState>
  </Model>
  <ListOfTasks>
    ...
    <Task key="Task_17" name="Scan" type="scan" scheduled="false" updateModel="false">
      <Report reference="Report_22" target="optimization_genetic_200_repeat_1.txt" append="0" confirmOverwrite="1"/>
      <Problem>
        <Parameter name="Subtask" type="unsignedInteger" value="4"/>
        <ParameterGroup name="ScanItems">
          <ParameterGroup name="ScanItem">
            <Parameter name="Number of steps" type="unsignedInteger" value="35"/>
    ...
    <Task key="Task_19" name="Optimization" type="optimization" scheduled="false" updateModel="false">
      <Report reference="Report_22" target="Optimization_genetic_200.txt" append="1" confirmOverwrite="0"/>
      <Problem>
        ...
        <ParameterGroup name="OptimizationItemList">
          <ParameterGroup name="OptimizationItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=New Model,Vector=Values[r],Reference=InitialValue"/>
            <Parameter name="LowerBound" type="cn" value="80"/>
            <Parameter name="UpperBound" type="cn" value="110"/>
            <Parameter name="StartValue" type="float" value="92.875543329999999"/>
          </ParameterGroup>
          <ParameterGroup name="OptimizationItem">
            <Parameter name="ObjectCN" type="cn" value="CN=Root,Model=New Model,Vector=Values[b],Reference=InitialValue"/>
            <Parameter name="LowerBound" type="cn" value="2.6"/>
            <Parameter name="UpperBound" type="cn" value="2.7"/>
            <Parameter name="StartValue" type="float" value="2.6912610238863297"/>
          </ParameterGroup>
        </ParameterGroup>
    ...
    <Task key="Task_26" name="Cross Section" type="crosssection" scheduled="false" updateModel="false">
      <Problem>
        ...
        <Parameter name="SingleVariable" type="cn" value="CN=Root,Model=New Model,Vector=Compartments[compartment],Vector=Metabolites[z],Reference=Rate"/>
      </Problem>
      <Method name="Deterministic (LSODA)" type="Deterministic(LSODA)">
        <Parameter name="Integrate Reduced Model" type="bool" value="0"/>
        <Parameter name="Relative Tolerance" type="unsignedFloat" value="9.9999999999999995e-07"/>
  ...
  <ListOfReports>
    ...
    <Report key="Report_20" name="report" taskType="timeCourse" separator="&#x09;" precision="6">
      ...
      <Header>
        <Object cn="CN=Root,Model=New Model,Vector=Values[r],Reference=InitialValue,Property=DisplayName"/>
        <Object cn="Separator=&#x09;"/>
      ...
      <Body>
        <Object cn="CN=Root,Model=New Model,Vector=Values[r],Reference=InitialValue"/>
        <Object cn="Separator=&#x09;"/>
    ...
    <Report key="Report_21" name="report_copy" taskType="timeCourse" separator="&#x09;" precision="6">
      ...
      <Body>
        <Object cn="CN=Root,Model=New Model,Vector=Values[r],Reference=InitialValue"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="CN=Root,Model=New Model,Vector=Values[b],Reference=InitialValue"/>
        <Object cn="Separator=&#x09;"/>
        <Object cn="CN=Root,Vector=TaskList[Lyapunov Exponents],Reference=Exponent 1"/>
      </Body>
    </Report>
    ...
    <PlotSpecification name="Lyapunov exponents" type="Plot2D" active="0" taskTypes="Scan">
      ...
      <ListOfPlotItems>
        <PlotItem name="TaskList[Lyapunov Exponents].Exponent 1|Values[c].InitialValue" type="Curve2D">
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Values[r],Reference=InitialValue"/>
    ...
    <PlotSpecification name="Lyapunov exponents_copy" type="Plot2D" active="0" taskTypes="Scan">
      ...
      <ListOfPlotItems>
        <PlotItem name="TaskList[Lyapunov Exponents].Exponent 1|Values[b].InitialValue" type="Curve2D">
          ...
          <Parameter name="Recording Activity" type="string" value="during"/>
          <ListOfChannels>
            <ChannelSpec cn="CN=Root,Model=New Model,Vector=Values[b],Reference=InitialValue"/>
            <ChannelSpec cn="CN=Root,Vector=TaskList[Lyapunov Exponents],Reference=Exponent 1"/>
          </ListOfChannels>
        </PlotItem>
      </ListOfPlotItems>
...
<dcterms:created>
<rdf:Description>
<dcterms:W3CDTF>2021-05-31T14:05:44Z</dcterms:W3CDTF>
</rdf:Description>
</dcterms:created>
</rdf:Description>
</rdf:RDF>
